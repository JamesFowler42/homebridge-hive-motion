...
module.exports = function(homebridge){
  ...
  homebridge.registerAccessory("homebridge-hive-motion", "HiveMotionSensor", HiveMotionSensor);
};

function HiveMotionSensor(log, config) {
	this.log = log;
	this.name = config.name;
	this.sensorService = new Service.MotionSensor();
...
HiveMotionSensor.prototype = {
	...
	getServices: function() {
		...
		return [this.sensorService,this.informationService];
	}
};
